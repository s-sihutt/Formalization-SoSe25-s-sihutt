...
\begin{frame}
	...
	\begin{itemize}
		...
		\item \textbf{Plan:} 
		\begin{itemize}
			\item Erste Hälfte: Grundlagen von Lean.
			\item Zweite Hälfte: Entscheiden wir später! 
		\end{itemize} 
		\item \textbf{Heute:} 
		\begin{itemize}
...
\begin{frame}
 \frametitle{Logistik}
	\begin{enumerate}
		...
		\item Erste Schritte: Installation von VS Code, Lean und Git und Anmeldung in GitHub
...
\begin{frame}
	...
	\begin{itemize}
		...
		\item Jeder der ein Projekt macht besteht.\footnote{Terms and Conditions apply.}
